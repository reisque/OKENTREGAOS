...
export default function App() {
  ...
  return <main className="page">
    ...
    {results.length > 0 && <section className="results"><div className="results-head"><div><h2>Resultado da consulta</h2><span>{foundCount} encontrada(s) de {visibleResults.length} exibida(s)</span></div></div><div className="table-scroll"><table><thead><tr><th>Ordem de serviço</th><th>Status</th><th>Booking</th><th>Contêiner</th><th>Contratante</th><th>Depot</th><th>XML</th></tr></thead><tbody>{visibleResults.map((item, index) => item.found
